      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          <nav className="flex items-center justify-between mb-4">
            <div className="text-sm font-mono text-green-400">► CYBERSEC.DIR v1.0</div>
            <Link
              href="/blog"
              className="text-sm font-mono text-cyan-400 hover:text-magenta-400 transition-colors border-2 border-cyan-500 hover:border-magenta-500 px-4 py-2 bg-black/50"
            >
              ► BLOG / TIPS
            </Link>
          </nav>
