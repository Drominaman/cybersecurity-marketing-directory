...
const mdxComponents = {
  ...
  h2: (props: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h2 className="text-2xl md:text-3xl font-black text-white mb-4 mt-8 uppercase" {...props} />
  ),
  ...
  code: (props: React.HTMLAttributes<HTMLElement>) => (
    <code className="bg-gray-800 border border-white/20 px-2 py-1 text-sm font-mono text-gray-200" {...props} />
  ),
  pre: (props: React.HTMLAttributes<HTMLPreElement>) => (
    <pre className="bg-gray-900 border-2 border-white p-4 overflow-x-auto mb-6 font-mono text-sm" {...props} />
  ),
  strong: (props: React.HTMLAttributes<HTMLElement>) => (
    <strong className="text-white font-bold" {...props} />
  ),
  hr: () => (
    <hr className="border-t-2 border-white/20 my-8" />
  ),
...
export default async function BlogPostPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Article */}
      <article id="main-content" className="max-w-4xl mx-auto px-4 py-12">
        {/* Article Header */}
        <header className="mb-10">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white mb-6 uppercase leading-tight">
            {post.title}
          </h1>
            ...
            <div className="flex flex-wrap gap-2">
              {post.tags.map(tag => (
                <Link
                  ...
                  className="bg-gray-800 border-2 border-white text-gray-300 px-3 py-1 text-xs font-bold hover:border-gray-400 hover:text-gray-300 transition-colors"
                >
                  {tag}
                </Link>
              ))}
        ...
        {relatedPosts.length > 0 && (
          <section className="border-4 border-white bg-gray-900/50 p-6 mb-10">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {relatedPosts.map(related => (
                <Link
                  ...
                  className="block bg-black border-2 border-white/20 p-4 hover:border-gray-400 transition-colors"
                >
