...
Project pricing suits one-off needs and is a sensible way to test an agency before committing to a retainer. Bluetext, Magnetude Consulting, and Envy (GoEnvy) operate primarily on this model.
